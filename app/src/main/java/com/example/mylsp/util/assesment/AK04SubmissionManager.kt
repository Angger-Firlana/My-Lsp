...
import com.example.mylsp.model.api.assesment.SubmissionQuestion
...
class Ak04SubmissionManager(context: Context) {
    ...
    fun saveAnswer(
        ...
        val updated = SubmissionQuestion(ak04_question_id = questionId, selected_option = selectedOption)
